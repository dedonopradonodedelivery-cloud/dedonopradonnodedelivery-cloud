...
export const StoreAdsModule: React.FC<StoreAdsModuleProps> = ({ onBack, onNavigate, user, categoryName, viewMode, initialView = 'sales' }) => {
  ...
  const handleSaveDesign = (design: any) => {
    ...
    setView('sales'); // Retorna automaticamente para a página de checkout
  };
    ...
    return (
      <div className="min-h-screen bg-[#020617] text-slate-100 font-sans flex flex-col">
        ...
        <main className="flex-1 p-6 space-y-12 pb-64 max-w-md mx-auto w-full overflow-y-auto no-scrollbar">
            ...
            {/* PREVIEW DO BANNER CONCLUÍDO - POSICIONADO ACIMA DO PERÍODO */}
            {isArtSaved && savedDesign && (
              <section className="animate-in fade-in zoom-in-95 duration-500 space-y-4">
                ...
                <div className="relative group">
                  ...
                  {/* Etiqueta Premium Style */}
                  <div className="absolute -top-3 -left-2 bg-slate-900/80 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-xl flex items-center gap-2 shadow-2xl">
                     <Sparkles size={12} className="text-amber-400" />
                     <span className="text-[8px] font-black text-white uppercase tracking-widest">Design Premium Ativo</span>
                  </div>
                </div>
