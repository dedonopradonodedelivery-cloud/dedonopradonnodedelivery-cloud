...
export const CouponLandingView: React.FC<CouponLandingViewProps> = ({ onBack, onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 font-sans animate-in slide-in-from-right duration-300 flex flex-col">
      ...
      {/* Main Content with increased bottom padding to account for raised footer */}
      <main className="flex-1 overflow-y-auto no-scrollbar p-6 pb-48">
        ...
        <section className="text-center mb-10 mt-4">
          ...
          <h2 className="text-2xl font-black text-gray-900 dark:text-white leading-tight mb-3">
            Descontos exclusivos para quem mora e compra no bairro
          </h2>
      ...
      {/* Footer CTA - Raised to sit above BottomNav (approx 80px) */}
      <footer className="fixed bottom-[80px] left-0 right-0 p-6 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 z-50 max-w-md mx-auto shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
        <button 
          onClick={onLogin}
