...
export const SUBCATEGORIES: Record<string, { name: string; icon: React.ReactNode }[]> = {
  'Comida': [
    ...
    { name: 'Lanches & Hamburguerias', icon: <Utensils /> },
    { name: 'Pizzarias', icon: <Utensils /> },
    { name: 'Cafés & Cafeterias', icon: <Utensils /> },
    { name: 'Delivery', icon: <Utensils /> },
    { name: 'Doces & Sobremesas', icon: <Utensils /> },
    { name: 'Comida Caseira', icon: <Utensils /> },
    { name: 'Hortifruti & Naturais', icon: <Utensils /> },
  ],
  'Eventos': [
    { name: 'Eventos no Bairro', icon: <PartyPopper /> },
    { name: 'Festas & Comemorações', icon: <PartyPopper /> },
    { name: 'Feiras & Exposições', icon: <PartyPopper /> },
    { name: 'Eventos Gastronômicos', icon: <PartyPopper /> },
    { name: 'Eventos Culturais', icon: <PartyPopper /> },
    { name: 'Eventos Esportivos', icon: <PartyPopper /> },
    { name: 'Eventos Infantis', icon: <PartyPopper /> },
    { name: 'Eventos em Condomínio', icon: <PartyPopper /> },
  ],
  'Pets': [
    { name: 'Veterinários', icon: <PawPrint /> },
    { name: 'Pet Shop', icon: <PawPrint /> },
    { name: 'Banho & Tosa', icon: <PawPrint /> },
    { name: 'Adestramento', icon: <PawPrint /> },
    { name: 'Hospedagem Pet', icon: <PawPrint /> },
    { name: 'Passeadores', icon: <PawPrint /> },
    { name: 'Produtos Pet', icon: <PawPrint /> },
    { name: 'Pets Exóticos', icon: <PawPrint /> },
  ],
  'Profissionais': [
    { name: 'Eletricista', icon: <Briefcase /> },
    { name: 'Encanador', icon: <Briefcase /> },
    { name: 'Pintor', icon: <Briefcase /> },
    { name: 'Pedreiro', icon: <Briefcase /> },
    { name: 'Técnico em Informática', icon: <Briefcase /> },
    { name: 'Montador de Móveis', icon: <Briefcase /> },
    { name: 'Marido de Aluguel', icon: <Briefcase /> },
    { name: 'Freelancers em Geral', icon: <Briefcase /> },
  ],
  'Saúde': [
    { name: 'Clínicas', icon: <Heart /> },
    { name: 'Dentistas', icon: <Heart /> },
    { name: 'Psicologia', icon: <Heart /> },
    { name: 'Fisioterapia', icon: <Heart /> },
    { name: 'Exames & Diagnósticos', icon: <Heart /> },
    { name: 'Nutrição', icon: <Heart /> },
    { name: 'Terapias Alternativas', icon: <Heart /> },
    { name: 'Saúde Preventiva', icon: <Heart /> },
  ],
  'Serviços': [
    { name: 'Limpeza Residencial', icon: <Wrench /> },
    { name: 'Dedetização', icon: <Wrench /> },
    { name: 'Manutenção Geral', icon: <Wrench /> },
    { name: 'Chaveiro', icon: <Wrench /> },
    { name: 'Segurança', icon: <Wrench /> },
    { name: 'Serviços Rápidos', icon: <Wrench /> },
  ...
  'Beleza': [
    ...
    { name: 'Manicure & Pedicure', icon: <Scissors /> },
    { name: 'Estética Facial', icon: <Scissors /> },
    { name: 'Estética Corporal', icon: <Scissors /> },
    { name: 'Maquiagem', icon: <Scissors /> },
    { name: 'Sobrancelhas & Cílios', icon: <Scissors /> },
    { name: 'Spa & Relaxamento', icon: <Scissors /> },
  ],
  'Autos': [
    { name: 'Oficinas Mecânicas', icon: <CarFront /> },
    { name: 'Lava-Jato', icon: <CarFront /> },
    { name: 'Auto Elétrica', icon: <CarFront /> },
    { name: 'Pneus & Alinhamento', icon: <CarFront /> },
    { name: 'Funilaria & Pintura', icon: <CarFront /> },
    { name: 'Peças & Acessórios', icon: <CarFront /> },
    { name: 'Vistoria & Documentação', icon: <CarFront /> },
    { name: 'Serviços Rápidos Auto', icon: <CarFront /> },
  ],
  'Mercado': [
    { name: 'Supermercados', icon: <ShoppingCart /> },
    { name: 'Mercados de Bairro', icon: <ShoppingCart /> },
    { name: 'Atacarejo', icon: <ShoppingCart /> },
    { name: 'Conveniência', icon: <ShoppingCart /> },
    { name: 'Produtos Importados', icon: <ShoppingCart /> },
    { name: 'Bebidas', icon: <ShoppingCart /> },
    { name: 'Produtos Congelados', icon: <ShoppingCart /> },
    { name: 'Assinaturas & Cestas', icon: <ShoppingCart /> },
  ],
  'Casa': [
    { name: 'Materiais de Construção', icon: <HomeIcon /> },
    { name: 'Decoração', icon: <HomeIcon /> },
    { name: 'Iluminação', icon: <HomeIcon /> },
    { name: 'Móveis', icon: <HomeIcon /> },
    { name: 'Eletrodomésticos', icon: <HomeIcon /> },
    { name: 'Jardinagem', icon: <HomeIcon /> },
    { name: 'Organização', icon: <HomeIcon /> },
    { name: 'Reforma & Obras', icon: <HomeIcon /> },
  ],
  'Esportes': [
    { name: 'Academias', icon: <Dumbbell /> },
    { name: 'Personal Trainer', icon: <Dumbbell /> },
    { name: 'Esportes Coletivos', icon: <Dumbbell /> },
    { name: 'Artes Marciais', icon: <Dumbbell /> },
    { name: 'Yoga & Pilates', icon: <Dumbbell /> },
    { name: 'Dança', icon: <Dumbbell /> },
    { name: 'Treino Funcional', icon: <Dumbbell /> },
    { name: 'Esportes ao Ar Livre', icon: <Dumbbell /> },
  ],
  'Lazer': [
    { name: 'Eventos', icon: <Ticket /> },
    { name: 'Shows & Música', icon: <Ticket /> },
    { name: 'Cinema & Teatro', icon: <Ticket /> },
    { name: 'Bares & Baladas', icon: <Ticket /> },
    { name: 'Passeios', icon: <Ticket /> },
    { name: 'Turismo Local', icon: <Ticket /> },
    { name: 'Experiências', icon: <Ticket /> },
    { name: 'Atividades em Família', icon: <Ticket /> },
  ],
  'Educação': [
    { name: 'Escolas', icon: <BookOpen /> },
    { name: 'Cursos Livres', icon: <BookOpen /> },
    { name: 'Idiomas', icon: <BookOpen /> },
    { name: 'Reforço Escolar', icon: <BookOpen /> },
    { name: 'Aulas Particulares', icon: <BookOpen /> },
    { name: 'Educação Infantil', icon: <BookOpen /> },
    { name: 'Cursos Profissionalizantes', icon: <BookOpen /> },
    { name: 'Tecnologia & Programação', icon: <BookOpen /> },
  ],
  'Farmácia': [
    { name: 'Medicamentos', icon: <Pill /> },
    { name: 'Genéricos', icon: <Pill /> },
    { name: 'Manipulação', icon: <Pill /> },
    { name: 'Perfumaria', icon: <Pill /> },
    { name: 'Higiene & Cuidados', icon: <Pill /> },
    { name: 'Testes Rápidos', icon: <Pill /> },
    { name: 'Suplementos', icon: <Pill /> },
    { name: 'Delivery Farmácia', icon: <Pill /> },
  ],
  'Moda': [
    { name: 'Moda Feminina', icon: <Shirt /> },
    { name: 'Moda Masculina', icon: <Shirt /> },
    { name: 'Moda Infantil', icon: <Shirt /> },
    { name: 'Calçados', icon: <Shirt /> },
    { name: 'Acessórios', icon: <Shirt /> },
    { name: 'Moda Íntima', icon: <Shirt /> },
    { name: 'Moda Fitness', icon: <Shirt /> },
    { name: 'Brechós', icon: <Shirt /> },
  ],
  'Condomínio': [
    { name: 'Avisos & Comunicados', icon: <Building2 /> },
    { name: 'Serviços para Condomínio', icon: <Building2 /> },
    { name: 'Manutenção Predial', icon: <Building2 /> },
    { name: 'Segurança Condominial', icon: <Building2 /> },
    { name: 'Limpeza & Portaria', icon: <Building2 /> },
    { name: 'Indicações de Profissionais', icon: <Building2 /> },
    { name: 'Eventos do Condomínio', icon: <Building2 /> },
    { name: 'Achados & Perdidos', icon: <Building2 /> },
  ],
};
