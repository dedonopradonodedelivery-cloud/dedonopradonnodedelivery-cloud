...
// DATASET FAKE PARA BANNERS DE CATEGORIA (SEGMENTADO POR BAIRRO E CATEGORIA)
// Generalizando para que o componente CategoryTopCarousel funcione em qualquer categoria
export const CATEGORY_TOP_BANNERS: Record<string, Record<string, { image: string; storeId: string }[]>> = {
  ...
  'autos': {
    'Anil': [
      { image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800', storeId: 'f-4' },
      { image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=800', storeId: 'fake-autos-0' }
    ],
    'Freguesia': [
      { image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?q=80&w=800', storeId: 'fake-autos-1' },
      { image: 'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?q=80&w=800', storeId: 'fake-autos-2' }
    ]
  },
  'mercado': {
    'Freguesia': [
  ...
  'moda': {
    'Anil': [
      ...
      { image: 'https://images.unsplash.com/photo-1470309634658-8398b2cd0d23?q=80&w=800', storeId: 'fake-moda-0' }
    ],
    'Freguesia': [
