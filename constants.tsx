...
// FIX: Added missing CLASSIFIED_CATEGORIES export to resolve import error in MoreCategoriesModal.tsx
...
export const CATEGORY_TOP_BANNERS: Record<string, Record<string, { image: string; storeId: string }[]>> = {
  ...
  'beleza': {
    ...
    'Freguesia': [
      ...
      { image: 'https://images.unsplash.com/photo-1632345031435-8727f6897d53?q=80