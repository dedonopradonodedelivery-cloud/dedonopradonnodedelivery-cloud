...
const mockStores: Store[] = [
    { id: 'ms1', name: 'Pizza Place Freguesia', rating: 4.8, reviewsCount: 231, subcategory: 'Restaurantes & Delivery', distanceKm: 1.2, isOpenNow: true, closingTime: '23:00', isSponsored: true, logoUrl: getStoreLogo(9), adType: AdType.PREMIUM, category: 'Alimentação & Produtos', distance: '1.2km', description: 'Pizzas artesanais' },
    { id: 'ms2', name: 'Sabor & Cia', rating: 4.6, reviewsCount: 153, subcategory: 'Restaurantes & Delivery', distanceKm: 0.8, isOpenNow: true, closingTime: '22:00', isSponsored: false, logoUrl: getStoreLogo(1), adType: AdType.ORGANIC, category: 'Alimentação & Produtos', distance: '0.8km', description: 'Comida caseira' },
    { id: 'ms3', name: 'Cantinho da Massa - O melhor da Itália no seu bairro', rating: 4.9, reviewsCount: 302, subcategory: 'Restaurantes & Delivery', distanceKm: 2.1, isOpenNow: false, closingTime: '22:00', isSponsored: true, logoUrl: getStoreLogo(2), adType: AdType.PREMIUM, category: 'Alimentação & Produtos', distance: '2.1km', description: 'Massas frescas' },
    { id: 'ms4', name: 'Bistrô da Freguesia', rating: 4.7, reviewsCount: 87, subcategory: 'Restaurantes & Delivery', distanceKm: 0.4, isOpenNow: true, closingTime: '22:30', isSponsored: false, logoUrl: getStoreLogo(3), adType: AdType.LOCAL, category: 'Alimentação & Produtos', distance: '0.4km', description: 'Culinária francesa' },
    { id: 'ms5', name: 'Hamburgueria do Parque', rating: 4.5, reviewsCount: 241, subcategory: 'Restaurantes & Delivery', distanceKm: 3.5, isOpenNow: false, closingTime: '00:00', isSponsored: false, logoUrl: getStoreLogo(4), adType: AdType.ORGANIC, category: 'Alimentação & Produtos', distance: '3.5km', description: 'Burgers artesanais' },
];
