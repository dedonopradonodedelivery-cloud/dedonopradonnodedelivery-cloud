      ...
      <div className="min-h-screen bg-[#F8F9FC] dark:bg-gray-950 font-sans animate-in slide-in-from-right duration-300 flex flex-col relative overflow-x-hidden">
        ...
        {view === 'payment' ? (
          <main className="flex-1 p-6 space-y-8 overflow-y-auto no-scrollbar pb-32">
              ...
              {paymentMethod === 'pix' ? (
                ...
                <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-8 border border-gray-100 dark:border-gray-800 space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input type="text" placeholder="0000 0000 0000 0000" className="w-full p-4 bg-gray-50 dark:bg-gray-800 border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-blue-500" />
                  </div>
            ...
            <div className="fixed bottom-[80px] left-0 right-0 p-6 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 z-50 max-w-md mx-auto shadow-[0_-10px_30px_rgba(0,0,0,0.05)]">
               <button 
          ...
          <main className="flex-1 overflow-y-auto no-scrollbar pb-64">
            ...
            <section className="px-6 mb-12">
              <h3 className="text-xs font-black text-gray-400 uppercase tracking-[0.2em] mb-6 ml-1">Por que ser Master</h3>
              <div className="space-y-4">
                {[
                  { icon: Target, title: "Presença constante", desc: "Sua marca em pontos estratégicos do app." },
                  { icon: Award, title: "Top of mind local", desc: "Você vira referência absoluta no bairro." },
                  { icon: Lock, title: "Exclusividade", desc: "Apenas 1 Patrocinador Master ativo por período." },
                ].map((item, i) => (
                  <div key={i} className="flex gap-4 p-5 bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
                    <div className="w-10 h-10 bg-blue-50 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center text-[#1E5BFF] shrink-0">
                      <item.icon size={20} />
                    </div>
                    <div>
            ...
            <section className="px-6 mb-12">
              <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-6 border border-gray-100 dark:border-gray-800 shadow-sm">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-6 leading-relaxed">
                  Selecione os meses de exclusividade.
                </p>
                        ...
                        className={`
                          ...
                          ${!month.available 
                            ...
                            : isSelected 
                              ...
                              : 'bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-800 text-gray-400'}
                        `}
                      >
                        {month.label}
                      </button>
            ...
            <div className="fixed bottom-[80px] left-0 right-0 z-[50] bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-t border-gray-100 dark:border-gray-800 p-6 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] max-w-md mx-auto">
              <div className="flex items-center justify-between mb-4">
                <div className="flex flex-col">
                  <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">{totals.count} Mês Selecionado</span>
                  <div className="flex items-baseline gap-2">
              ...
              <button 
                ...
                className={`
                  ...
                  ${selectedMonthIds.length === 0 
                    ...
                    : 'bg-[#1E5BFF] text-white shadow-blue-500/30 active:scale-[0.98]'}
                `}
              >
