...
import { ChevronLeft, Wrench, Briefcase, Info, Sparkles, Hammer, Paintbrush, Zap, Droplets, Leaf, HardHat } from 'lucide-react';
        ...
        <main className="p-6 pt-12 space-y-10">
            <div className="text-center space-y-3 mb-4 relative">
                ...
                <h2 className="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tighter leading-tight">
                    Serviços em <br/> Jacarepaguá <span className="text-blue-500">🛠️✨</span>
                </h2>
                <p className="text-sm text-gray-500 dark:text-gray-400 font-medium leading-relaxed">Encontre os melhores profissionais do bairro.</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <button
                    onClick={() => onSelect('Elétrica')}
                    className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-6 rounded-[2.2rem] flex flex-col items-center justify-center text-center gap-4 transition-all active:scale-95 shadow-sm hover:shadow-md group"
                >
                    <div className="w-16 h-16 rounded-[1.5rem] bg-yellow-500 bg-opacity-10 flex items-center justify-center text-yellow-500 group-hover:scale-110 transition-transform duration-500">
