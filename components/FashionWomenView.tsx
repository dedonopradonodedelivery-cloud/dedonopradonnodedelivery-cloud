      ...
      <div className="flex-1 bg-white dark:bg-gray-950 rounded-t-[3.5rem] -mt-6 pb-32 relative z-40 shadow-[0_-12px_40px_rgba(0,0,0,0.12)]">
        <main className="p-6 pt-12 space-y-10">
          <div 
              ...
              className="py-14 px-8 bg-rose-600 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden cursor-pointer active:scale-[0.99] transition-all group"
          >
            ...
            <section key={idx} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {group.items.map((item, itemIdx) => (
                  ...
                  >
                    {item.isPopular && (
                        <span className="absolute top-4 right-4 bg-rose-100 text-rose-700 text-[8px] font-black px-1.5 py-0.5 rounded uppercase tracking-widest">Trend</span>
                    )}
