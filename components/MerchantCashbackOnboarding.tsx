...
export const MerchantCashbackOnboarding: React.FC<MerchantCashbackOnboardingProps> = ({ onBack, onActivate }) => {
  const benefits = [
    ...
    },
    {
      ...
      desc: "Fortaleça a economia local atraindo usuários de outras lojas."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans animate-in slide-in-from-right duration-300 flex flex-col">
      ...
      <div className="flex-1 px-6 pb-32 overflow-y-auto no-scrollbar">
        ...
        <div className="text-center mt-4 mb-10">
          ...
          <h1 className="text-3xl font-black font-display leading-tight tracking-tight mb-3">
            ...
            <span className="text-amber-400">com cashback</span>
          </h1>
          ...
          <div className="relative z-10 flex items-start gap-4">
             ...
             <div>
                ...
                <p className="text-xs text-gray-400 leading-relaxed">
                  Você define o percentual que deseja devolver (ex: 5%) e os clientes acumulam saldo para usar em qualquer loja parceira da Freguesia.
                </p>
             </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-slate-950 via-slate-950 to-transparent">
        <button 
          onClick={onActivate}
          className="w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-black py-4 rounded-2xl shadow-[0_10px_30px_rgba(245,158,11,0.2)] active:scale-[0.98] transition-all flex items-center justify-center gap-2 text-base"
        >
