...
export const HomeFeed: React.FC<{
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-gray-950 w-full max-w-md mx-auto animate-in fade-in duration-700 overflow-x-hidden pb-32 rounded-t-[3.5rem] -mt-24 relative z-20 shadow-[0_-20px_50px_rgba(0,0,0,0.12)] border-t border-white/10">
