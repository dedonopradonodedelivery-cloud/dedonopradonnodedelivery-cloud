...
export const HomeFeed: React.FC<HomeFeedProps> = ({ 
    ...
    timeout = setTimeout(async () => {
        try {
            ...
            const mapped: Store[] = (data || []).map((item: any) => ({
                ...
                rating: item.rating || 0, distance: 'Freguesia', adType: AdType.ORGANIC,
            }));
  ...
  return (
    <div className="flex flex-col gap-5 pb-28 bg-gray-50 dark:bg-gray-900 w-full max-w-md mx-auto !pt-0 animate-in fade-in duration-500">
      ...
      {activeSearchTerm ? (
        ...
        <div className="flex flex-col gap-5 w-full mt-4">
            ...
            {/* 1. HERO & VALUE PROP (PRIMARY HIERARCHY) */}
               ...
               <div className="w-full bg-[#1E5BFF] rounded-[32px] p-6 text-white relative overflow-hidden shadow-2xl shadow-blue-500/20">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-4 opacity-90">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">{onlineVizinhos} vizinhos economizando agora</span>
                    </div>
                    ...
                    <button 
                      ...
                      className="w-full bg-white text-[#1E5BFF] text-sm font-black py-4 rounded-2xl active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-xl shadow-black/10"
                    >
            ...
            {/* 2. DASHBOARD / PROGRESS (UTILITY HIERARCHY) */}
            <div className="px-5 w-full">
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col gap-3 active:scale-[0.99] transition-all cursor-pointer group" onClick={() => onNavigate('user_cashback_flow')}>
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tight leading-none mb-1">Saldo Acumulado</p>
                                <p className="text-lg font-black text-gray-900 dark:text-white leading-none">R$ 12,50</p>
                            </div>
                        </div>
                        <div className="text-right">
                            <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Meta</p>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="flex justify-between items-center text-[9px] font-black text-gray-400 uppercase tracking-tight">
                            <span className="flex items-center gap-1"><TrendingUp className="w-2.5 h-2.5" /> 25% da meta batida</span>
                            <span className="text-[#1E5BFF] flex items-center gap-1 font-black">Faltam R$ 37,50 <ChevronRight className="w-2.5 h-2.5" /></span>
                        </div>
                    </div>
                </div>
            </div>

            {/* 3. NAVIGATION CHIPS (ACTION HIERARCHY) */}
            <div className="px-5 w-full -mb-1 mt-1">
            ...
            <div className="space-y-4 w-full">
                ...
                <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar snap-x px-5">
                    {EDITORIAL_THEMES.map((theme) => (
                        <div 
                            key={theme.id} 
                            className="snap-center min-w-[240px] w-[240px] h-[150px] rounded-[32px] overflow-hidden relative cursor-pointer active:scale-95 transition-all shadow-lg group"
            ...
            {/* 6. GAMIFICATION & BONUSES (SECONDARY HIERARCHY) */}
            <div className="px-5 mt-2 space-y-4">
                <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xs font-black text-gray-400 uppercase tracking-[0.2em]">Ganhe Bônus</h3>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <button 
                        ...
                        className="bg-white dark:bg-gray-800 p-4 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col items-center gap-3 active:scale-95 transition-transform"
                    >
                        ...
                        <div className="text-center">
                            <p className="text-xs font-black text-gray-900 dark:text-white">Girar Roleta</p>
                    ...
                    >
                        ...
                        <div className="text-center">
                            <p className="text-xs font-black text-gray-900 dark:text-white">Indicar Vizinho</p>
