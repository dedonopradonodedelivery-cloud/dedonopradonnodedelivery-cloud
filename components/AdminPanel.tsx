...
export const AdminPanel: React.FC<AdminPanelProps> = ({ onBack, onInspectMerchant, onInspectUser }) => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // FIX: Removed unnecessary empty object argument from fetchAdminLedger call as it expects 0 arguments
        ...
        {activeTab !== 'metrics' && (
            <div className="relative mb-8 group">
                ...
                <input 
                    ...
                    className="w-full bg-slate-900 border border-white/5 rounded-2xl py-4 pl-12 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#1E5BFF]/50 transition-all"
                />
            </div>
        )}
