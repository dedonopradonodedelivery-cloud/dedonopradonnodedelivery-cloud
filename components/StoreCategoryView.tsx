...
const mockProducts = [
  { id: 1, name: 'Hambúrguer Clássico da Casa com Queijo', price_original: '32.50', price_current: '28.50', image: 'https://images.unsplash.com/photo-1550547660-d9450f859349?q=80&w=400&auto=format&fit=crop' },
  { id: 2, name: 'Batata Frita Especial com Alecrim e Páprica', price_original: '15.00', price_current: '15.00', image: 'https://images.unsplash.com/photo-1606756790138-aa6f1afa76f4?q=80&w=400&auto=format&fit=crop' },
  { id: 3, name: 'Pizza Marguerita Grande (8 Fatias)', price_original: '55.00', price_current: '49.90', image: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=400&auto=format&fit=crop' },
  { id: 4, name: 'Coca-Cola Lata 350ml', price_original: '6.00', price_current: '6.00', image: 'https://images.unsplash.com/photo-1622483767028-3f66f32a6444?q=80&w=400&auto=format&fit=crop' },
  { id: 5, name: 'Milkshake de Chocolate Belga com Pedaços', price_original: '22.00', price_current: '22.00', image: 'https://images.unsplash.com/photo-1627998691138-c3f15c1b523e?q=80&w=400&auto=format&fit=crop' },
  { id: 6, name: 'Sundae de Caramelo com Castanhas', price_original: '20.00', price_current: '18.00', image: 'https://images.unsplash.com/photo-1570197788417-0e82375c934d?q=80&w=400&auto=format&fit=crop' },
  { id: 7, name: 'Frango Frito Crocante (Balde)', price_original: '39.90', price_current: '39.90', image: 'https://images.unsplash.com/photo-1569058242253-92a9c5552db3?q=80&w=400&auto=format&fit=crop' },
  { id: 8, name: 'Suco Natural de Laranja 500ml', price_original: '9.00', price_current: '9.00', image: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?q=80&w=400&auto=format&fit=crop' },
];
