    ...
    <div className="flex flex-col bg-brand-blue w-full max-w-md mx-auto min-h-screen animate-in fade-in duration-500">
      <header className="sticky top-0 z-50 bg-brand-blue px-6 pt-12 pb-6 flex items-center justify-between border-b border-white/10 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-black text-white uppercase tracking-tighter leading-none">Manuais</h1>
        </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {group.items.map((item, itemIdx) => (
                  ...
                  >
                    ...
                    {item.isPopular && (
                        <span className="absolute top-3 right-3 bg-amber-100 text-amber-700 text-[7px] font-black px-1.5 py-0.5 rounded uppercase tracking-widest">Top</span>
                    )}
                  </button>
                ))}
              </div>
