  ...
  return (
    <div className="fixed inset-0 z-[2000] bg-black/60 backdrop-blur-sm flex items-end justify-center animate-in fade-in duration-200" onClick={onClose}>
      ...
      >
        ...
        <div className="p-6 border-b border-gray-100 dark:border-gray-800 shrink-0">
          ...
          <div className="relative">
            ...
            <input 
              ...
              placeholder="O que você procura? (ex: Pizza, Pet, Advogado)"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">
                      {(SUBCATEGORIES[cat.name] || []).length} subcategorias
                    </p>
                  </div>
                </div>
        ...
        {/* Footer Informativo */}
        <div className="p-6 bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 shrink-0">
          <div className="flex items-start gap-3 opacity-60">
            <Tag size={16} className="text-gray-400 mt-0.5" />
            <p className="text-[10px] text-gray-500 dark:text-gray-400 leading-relaxed font-bold uppercase">
              Todas as categorias e subcategorias são auditadas para garantir a melhor busca no bairro.
            </p>
          </div>
        </div>
      </div>
