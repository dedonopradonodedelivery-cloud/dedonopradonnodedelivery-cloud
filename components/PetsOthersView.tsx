            ...
            <section key={idx} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {group.items.map((item, itemIdx) => (
                  ...
                  >
                    {item.isPopular && (
                        <span className="absolute top-4 right-4 bg-emerald-100 text-emerald-700 text-[8px] font-black px-1.5 py-0.5 rounded uppercase tracking-widest">Especialista</span>
                    )}
