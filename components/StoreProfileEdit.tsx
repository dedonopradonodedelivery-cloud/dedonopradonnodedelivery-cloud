...
const TaxonomyField: React.FC<TaxonomyFieldProps> = ({ label, placeholder, options, selected, onSelect, required, allowCreate, onCreate, disabled }) => {
  ...
  // Note: We handled creation via a separate CTA button outside the dropdown for better UX as per requirements.
  // But keeping basic structure in case we want it inside too.
