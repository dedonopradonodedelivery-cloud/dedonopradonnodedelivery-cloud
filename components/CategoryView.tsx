...
export const CategoryView: React.FC<CategoryViewProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-24 animate-in slide-in-from-right duration-300 font-sans">
      ...
      <div className="p-5 pt-6 space-y-10">
           ...
           <div className="absolute inset-0 p-6 flex flex-col justify-center">
              ...
              <div className="space-y-0.5 opacity-90">
                 ...
                 <p className="text-[10px] text-white/60 uppercase tracking-widest font-medium">
                    Disponível para especialistas por bairro e especialidade
                 </p>
              </div>
           </div>
