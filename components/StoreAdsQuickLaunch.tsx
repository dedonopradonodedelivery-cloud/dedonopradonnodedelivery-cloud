        ...
        <>
                ...
                <section className="space-y-4">
                    ...
                    <div className="bg-slate-800/50 p-6 rounded-3xl border border-slate-700">
                        ...
                        <input 
                            ...
                            className="w-full h-2 bg-slate-700 rounded-lg appearance-none cursor-pointer range-lg accent-blue-500"
                        />
                    ...
                    <div className="mt-4 text-center">
                        <p className="text-xs text-slate-400">Custo: <span className="font-bold text-slate-200">R$ 0,99 por dia</span></p>
                    </div>
                </section>
            </main>
            <footer className="fixed bottom-[80px] left-0 right-0 p-5 bg-slate-950/80 backdrop-blur-md border-t border-white/5 z-30 max-w-md mx-auto">
                <div className="flex gap-3">
                    ...
                    >
                        Ativar por {duration} dias <ArrowRight size={16} />
                    </button>
                </div>
            </footer>
        </>
         ...
         <main className="flex-1 p-6 flex flex-col justify-center animate-in fade-in duration-300">
            ...
            <div className="bg-slate-900 rounded-3xl p-6 border border-white/10 space-y-4">
                ...
                <div className="flex justify-between items-center pt-2">
                    ...
                    <span className="text-2xl font-black text-emerald-400">R$ {totalPrice.toFixed(2).replace('.', ',')}</span>
                </div>
            </div>
    ...
    const renderSuccessScreen = () => (
        <main className="flex-1 p-6 flex flex-col items-center justify-center text-center animate-in zoom-in-95 duration-500">
            ...
            <p className="text-slate-400 max-w-sm mb-6 leading-relaxed">
                Parabéns pela escolha de se destacar! Seu Destaque Patrocinado já está ativo por {duration} dias.
            </p>
